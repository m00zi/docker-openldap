...
##
## ldap:
##   image: "gluufederation/openldap:latest"
##   environment:
##     - GLUU_KV_HOST=consul
##     - GLUU_KV_PORTT=8500
...
##   depends_on:
##     - consul
##   command: ["./scripts/wait-for-consul.sh", "/entrypoint.sh"]
##
...
LAST_CONSUL_VALUE_URI=${GLUU_KV_HOST-localhost}:${GLUU_KV_PORT-8500}/v1/kv/gluu/config/oxauth_openid_jwks_fn
MAX_WAIT=240
